...
// Копирование WebP
gulp.task('webp', () =>
    gulp.src(['src/img/**/*.{jpg,jpeg,png}', '!src/img/favicon/**/*', '!src/img/icons/**/*'])
    .pipe(webp())
...
gulp.task(
    ...
    gulp.series(
        ...
        gulp.parallel('sass', 'pug', 'copy:fonts', 'copy:img', 'webp', 'copy:css', 'copy:js', 'copy:mailer', 'copy:uber', 'copy:pulse'),
